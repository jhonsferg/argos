...
const file_proto_users_proto_rawDesc = "" +
	"\n" +
	"\x11proto/users.proto\x12\busers.v1\"@\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"CreateUser\x12\x1b.users.v1.CreateUserRequest\x1a\x0e.users.v1.UserB:Z8github.com/jhonsferg/argos/samples/users-service/userspbb\x06proto3"
...
var file_proto_users_proto_depIdxs = []int32{
	...
	2, // 1: users.v1.Users.CreateUser:input_type -> users.v1.CreateUserRequest
	0, // 2: users.v1.Users.GetUser:output_type -> users.v1.User
	0, // 3: users.v1.Users.CreateUser:output_type -> users.v1.User
