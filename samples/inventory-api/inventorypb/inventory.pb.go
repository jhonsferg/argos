...
const file_inventory_proto_rawDesc = "" +
	"\n" +
	"\x0finventory.proto\x12\finventory.v1\"J\n" +
	"\x13ReserveStockRequest\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\tR\x06itemId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\"M\n" +
	"\x14ReserveStockResponse\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\tR\x06itemId\x12\x1c\n" +
	"\tremaining\x18\x02 \x01(\x05R\tremaining2b\n" +
	"\tInventory\x12U\n" +
	"\fReserveStock\x12!.inventory.v1.ReserveStockRequest\x1a\".inventory.v1.ReserveStockResponseB>Z<github.com/jhonsferg/argos/samples/inventory-api/inventorypbb\x06proto3"
...
var file_inventory_proto_depIdxs = []int32{
	0, // 0: inventory.v1.Inventory.ReserveStock:input_type -> inventory.v1.ReserveStockRequest
	1, // 1: inventory.v1.Inventory.ReserveStock:output_type -> inventory.v1.ReserveStockResponse
